...
function startGame(){
    ...
    const ghosts = [
        new Ghosts(5,188,randomMovement,OBJECT_TYPE.BLINKY),
        new Ghosts(4,209,randomMovement,OBJECT_TYPE.PINKY),
        new Ghosts(3,213,randomMovement,OBJECT_TYPE.INKY),
        new Ghosts(2,251,randomMovement,OBJECT_TYPE.CLYDE),
    ];
